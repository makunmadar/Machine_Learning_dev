...
for i in range(9):
    ...
    axs[i].plot(bins, yhat_1[i], '--', label="1", alpha=0.5)
    axs[i].plot(bins, yhat_2[i], '--', label="2", alpha=0.5)
    axs[i].plot(bins, yhat_3[i], '--', label="3", alpha=0.5)
    axs[i].plot(bins, yhat_4[i], '--', label="4", alpha=0.5)
    axs[i].plot(bins, yhat_5[i], '--', label="5", alpha=0.5)
    axs[i].plot(bins, yhatavg[i], 'k--', label="Avg ensemble")
...
for i in range(9):
    ...
    axs[i].plot(bins, yhat_1[i+95], '--', label="1", alpha=0.5)
    axs[i].plot(bins, yhat_2[i+95], '--', label="2", alpha=0.5)
    axs[i].plot(bins, yhat_3[i+95], '--', label="3", alpha=0.5)
    axs[i].plot(bins, yhat_4[i+95], '--', label="4", alpha=0.5)
    axs[i].plot(bins, yhat_5[i+95], '--', label="5", alpha=0.5)
    axs[i].plot(bins, yhatavg[i+95], 'k--', label="Avg ensemble")
    #axs[i].plot(bins, yhat_stacked[i], 'x--', label="Integrated stacked model", alpha=0.5)
    #axs[i].plot(bins, yhat_4[i], 'x--', label="LR: exp decay", alpha=0.5)
...
for i in range(9):
    ...
    axs[i].plot(bins, yhat_1[i+191], '--', label="1", alpha=0.5)
    axs[i].plot(bins, yhat_2[i+191], '--', label="2", alpha=0.5)
    axs[i].plot(bins, yhat_3[i+191], '--', label="3", alpha=0.5)
    axs[i].plot(bins, yhat_4[i+191], '--', label="4", alpha=0.5)
    axs[i].plot(bins, yhat_5[i+191], '--', label="5", alpha=0.5)
    axs[i].plot(bins, yhatavg[i+191], 'k--', label="Avg ensemble")
    #axs[i].plot(bins, yhat_stacked[i], 'x--', label="Integrated stacked model", alpha=0.5)
    #axs[i].plot(bins, yhat_4[i], 'x--', label="LR: exp decay", alpha=0.5)
